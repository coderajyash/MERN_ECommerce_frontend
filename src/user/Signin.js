...
const Signin = ()=>{
    ...
    const [values,setValues]=useState({
        ...
        error:"",
        loading:false,
        didRedirect:false//Redirecting on successful signin
    })
    ...
    const onSubmit=event=>{
        ...
        .catch(console.log("DB not reachable"))
    }
    ...
    return(
        ...
        <input onChange={handleChange("email")} value={email} type="text" className="form-control"></input>
        </div>
        <div className="form-group">
