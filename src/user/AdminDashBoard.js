...
const AdminDashBoard= ()=>{
    ...
    const adminRightSide = () => {
        ...
        return (
            ...
            <ul className="list-group">
            <li className="list-group-item">
            <span className="badge-success mr-2">Name: </span>{name}
            </li>
            <li className="list-group-item">
            <span className="badge-success mr-2">Email: </span>{email}
            </li>
            </ul>
            </div>
        )
    ...
    return (
        <Base className="container bg-info p-4" title="Hello Admin" description="Manage all your products here.">
        <div className="row">
        <div className="col-3">
        {adminLeftSide()}
        </div>
